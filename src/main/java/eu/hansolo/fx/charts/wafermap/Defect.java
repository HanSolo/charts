...
public final class Defect {
    ...
    public void setImageFilename(final String imageFilename) { this.imageFilename = imageFilename; }
    ...
    @Override public boolean equals(final Object other) {
        ...
        return id == defect.id && Double.compare(defect.xRel, xRel) == 0 && Double.compare(defect.yRel, yRel) == 0 && indexX == defect.indexX && indexY == defect.indexY && Double.compare(defect.sizeX, sizeX) == 0 &&
               Double.compare(defect.sizeY, sizeY) == 0 && Double.compare(defect.defectArea, defectArea) == 0 && Double.compare(defect.sizeD, sizeD) == 0 && classNumber == defect.classNumber && fineBinNumber == defect.fineBinNumber &&
               test == defect.test && clusterNumber == defect.clusterNumber && imageCount == defect.imageCount;
    }

    @Override public int hashCode() {
        return Objects.hash(id, xRel, yRel, indexX, indexY, sizeX, sizeY, defectArea, sizeD, classNumber, fineBinNumber, test, clusterNumber, imageCount);
    }
