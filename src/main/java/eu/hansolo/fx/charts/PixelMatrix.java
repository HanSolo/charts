...
public class PixelMatrix extends Region {
    ...
    public PixelMatrix(final int COLS, final int ROWS) {
        this(250, 250, COLS, ROWS, Color.BLUE, Color.TRANSPARENT, PixelShape.SQUARE);
    }
    ...
    public PixelMatrix(final double PREFERRED_WIDTH, final double PREFERRED_HEIGHT, final int COLS, final int ROWS, final Color DOT_ON_COLOR, final Color DOT_OFF_COLOR, final PixelShape DOT_SHAPE) {
    ...
    public boolean renderToImage(final String filename, final int width, final int height) {
        return Helper.renderToImage(PixelMatrix.this, width, height, filename);
    }
    ...
    public BufferedImage renderToImage(final int width, final int height) {
        return Helper.renderToImage(PixelMatrix.this, width, height);
    }
